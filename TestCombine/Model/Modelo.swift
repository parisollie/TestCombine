...
/*
 ...
 y creamos el modelo, usaulmente es una clase.

*/
import Combine

//Paso 1.1, ponemos el ObservableObject, para poder observarlo
// Lo cual va a estar observando los cambios que tengamos en nuestra clase.
class Modelo: ObservableObject {
    /*
     ...
     Pero cuando queremos que  se reflejen en otras vistas, siempre lleven de
     llevar el @publisher.
